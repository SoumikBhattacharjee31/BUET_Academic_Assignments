...
public:
    HashTable(int hash_table_size, string collision_resolution, int hash_number){
...
int main(){
    ...
    for(int hash_table_size:sizes){
        HashTable htsc5kh1(hash_table_size,"sc",1);
        HashTable htsc5kh2(hash_table_size,"sc",2);
        HashTable htds5kh1(hash_table_size,"dh",1);
        HashTable htds5kh2(hash_table_size,"dh",2);
        HashTable htcp5kh1(hash_table_size,"cp",1);
        HashTable htcp5kh2(hash_table_size,"cp",2);
        for(int i=0;i<number_of_words;i++)
            htsc5kh1.insert_key(words[i]);
        for(int i=0;i<number_of_words;i++)
            htsc5kh2.insert_key(words[i]);
        for(int i=0;i<number_of_words;i++)
            htds5kh1.insert_key(words[i]);
        for(int i=0;i<number_of_words;i++)
            htds5kh2.insert_key(words[i]);
        for(int i=0;i<number_of_words;i++)
            htcp5kh1.insert_key(words[i]);
        for(int i=0;i<number_of_words;i++)
            htcp5kh2.insert_key(words[i]);
        for(int i=0;i<number_of_selected_words;i++)
            htsc5kh1.find_key(selected_words[i].first);
        for(int i=0;i<number_of_selected_words;i++)
            htsc5kh2.find_key(selected_words[i].first);
        for(int i=0;i<number_of_selected_words;i++)
            htds5kh1.find_key(selected_words[i].first);
        for(int i=0;i<number_of_selected_words;i++)
            htds5kh2.find_key(selected_words[i].first);
        for(int i=0;i<number_of_selected_words;i++)
            htcp5kh1.find_key(selected_words[i].first);
        for(int i=0;i<number_of_selected_words;i++)
            htcp5kh2.find_key(selected_words[i].first);
        print_report(htsc5kh1,htsc5kh2,htds5kh1,htds5kh2,htcp5kh1,htcp5kh2);
        cout<<endl;
    }
    return 0;
}