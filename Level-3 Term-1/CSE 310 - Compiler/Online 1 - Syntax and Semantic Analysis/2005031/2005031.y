...
%token <symbolInfo> ID LPAREN RPAREN SEMICOLON COMMA LCURL RCURL INT FLOAT VOID LSQUARE CONST_INT RSQUARE FOR IF ELSE WHILE PRINTLN RETURN ASSIGNOP LOGICOP RELOP ADDOP MULOP NOT CONST_FLOAT INCOP DECOP BREAK CASE COLON SWITCH DEFAULT
%type  <symbolInfo> start program unit func_declaration func_definition parameter_list compound_statement var_declaration type_specifier declaration_list statements statement expression_statement variable expression logic_expression rel_expression simple_expression term unary_expression factor argument_list arguments cases cases_with_default default_case case
...
statement : var_declaration                                                                 {
	  ...
	  | SWITCH	LPAREN expression RPAREN LCURL cases_with_default RCURL						{fprintf(logout, "SWITCH	LPAREN expression RPAREN LCURL cases_with_default RCURL\n");}
	  ;

cases_with_default		:	  	cases default_case	{fprintf(logout, "cases_with_default		:	  	cases default_case\n");}
						   |	cases				{fprintf(logout, "cases_with_default		:	  	cases\n");}
						   ;
cases					:	cases case				{fprintf(logout, "cases					:	cases case\n");}
case					:	CASE CONST_INT COLON statement BREAK SEMICOLON		{fprintf(logout, "case					:	CASE CONST_INT COLON statement BREAK SEMICOLON\n");}
						|	CASE CONST_FLOAT COLON statement BREAK SEMICOLON	{fprintf(logout, "cases					:	CASE CONST_FLOAT COLON statement BREAK SEMICOLON\n");}
						;
default_case			:	DEFAULT CONST_INT COLON statement BREAK SEMICOLON	{fprintf(logout, "default_case			:	DEFAULT CONST_INT COLON statement BREAK SEMICOLON\n");}
						|	DEFAULT CONST_FLOAT COLON statement BREAK SEMICOLON	{fprintf(logout, "cases					:	DEFAULT CONST_FLOAT COLON statement BREAK SEMICOLON\n");}
						;
